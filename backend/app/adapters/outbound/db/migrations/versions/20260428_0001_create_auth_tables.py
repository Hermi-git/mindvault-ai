...
def upgrade() -> None:
    ...
    op.create_index("ix_membership_org_id", "organization_memberships", ["org_id"], unique=False)
...
def downgrade() -> None:
    op.drop_index("ix_membership_org_role_status", table_name="organization_memberships")
